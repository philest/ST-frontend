			...
			(S.cancelScroll = function() {
				...
				(S.animateScroll = function(t, a, r) {
					...
					if (d || h) {
						...
						f.header &&
							!p &&
							(p = document.querySelector(f.header)),
							v || (v = s(p));
						var b,
							y,
							E,
				...
				I = function(t) {
					if (
						...
						if ("#" === n) {
							...
							return (
								h.setAttribute("data-scroll-id", o),
								(h.id = ""),
			...
			return (
				(S.destroy = function() {
					m &&
						...
						e.removeEventListener("resize", O, !1),
						S.cancelScroll(),
						(m = null),
						(h = null),
						(g = null),
				...
				(S.init = function(a) {
					t &&
						...
						p && e.addEventListener("resize", O, !1));
				}),
				S.init(d),
				S
			);
